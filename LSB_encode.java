...
class LSB_encode {
	static final String MESSAGEFILE = "C:\\Users\\KANCHAN\\Desktop\\message.txt";
	static final String COVERIMAGEFILE = "C:\\Users\\KANCHAN\\Desktop\\cover.jpg";	
	static final String STEGIMAGEFILE = "C:\\Users\\KANCHAN\\Desktop\\steg.png";
...
BufferedImage theImage=readImageFile("C:/Users/KANCHAN/Desktop/cover.jpg");
...
File p = new File ("C:\\Users\\KANCHAN\\Desktop\\cover.jpg");
try{
...
public static void hideTheMessage (int[] bits, BufferedImage theImage) throws Exception{
	File f = new File ("C:\\Users\\KANCHAN\\Desktop\\steg.png");
	BufferedImage sten_img=null;
	int bit_l=bits.length/8;
	int bl_msg[]=new int[8];
	System.out.println("bit length "+bit_l);
